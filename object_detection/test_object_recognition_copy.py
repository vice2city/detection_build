...
def fairv2_test(args):
    ...
    save_dirs = "/data5/laiping/tianzhibei/data/test-12-2/test/"
    args.eval_options = {"submission_dir":"/data5/laiping/tianzhibei/test-12-2/work_dirs/"}
    ...
    # args.eval_options = {"submission_dir":"/data5/laiping/tianzhibei/work_dirs/fair1m_v2-11-8-less"}
...
if __name__ == '__main__':
    # # # 运行你的代码
    # color = "red"
    # image = Image.open('/data5/laiping/tianzhibei/data/webtest/0.tif')
    # main(color,"0.tif",image)
    main()
