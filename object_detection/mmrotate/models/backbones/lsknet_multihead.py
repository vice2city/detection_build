...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        attn_weights = torch.matmul(q, k.transpose(-2, -1)) / (self.head_dim ** 0.5)  # (B, num_heads, H*W, H*W)
        ...
        attn_output = attn_output.permute(0, 2, 1, 3).reshape(B, H * W, C)  # (B, H*W, C)
...
class LSKNet_multihead(BaseModule):
    ...
    def init_weights(self):
        ...
        if self.init_cfg is None:
            ...
            super(LSKNet_multihead, self).init_weights()
        # print("init_weights")
