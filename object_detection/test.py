...
def fairv2_test(args):
    # args.eval_options = {"submission_dir":"/data5/laiping/tianzhibei/work_dirs/fair1m_v2-11-8"}
    dataset_name = "DOTA"
    ...
    args.eval_options = {"submission_dir":"/data5/laiping/tianzhibei/work_dirs/17input_image"}
    save_dirs = "/data5/laiping/tianzhibei/input_image/test"
