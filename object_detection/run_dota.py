...
def car_test(args):
    # args.config = "/data5/laiping/tianzhibei/code/Large-Selective-Kernel-Network/configs/lsknet/lsk_s_fpn_1x_dota_le90.py"
    args.config = "/data5/laiping/tianzhibei/code/Large-Selective-Kernel-Network/configs/mobilenet/roi_trans_r50_fpn_1x_dota_le90.py"
    # args.checkpoint = "/data5/laiping/tianzhibei/checkpoint/lsk_s_fpn_1x_dota_le90_20230116-99749191.pth" 
    args.checkpoint  = "/data5/laiping/tianzhibei/checkpoint/roi_trans_swin_tiny_fpn_1x_dota_le90-ddeee9ae.pth"
    args.format_only = True
    # args.eval_options = {"submission_dir":"/data5/laiping/tianzhibei/code/Large-Selective-Kernel-Network/work_dirs/DOTA1"}
    args.eval_options = {"submission_dir":"/data5/laiping/tianzhibei/code/Large-Selective-Kernel-Network/work_dirs/DOTA-trans1"}
    save_dirs = "/data5/laiping/tianzhibei/code/Large-Selective-Kernel-Network/data/DOTA-test/test"

    # img_split_new.main(args.input_path,save_dirs)
    print(args)
